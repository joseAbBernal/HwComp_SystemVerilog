...
HD_PWD='/home/sidbrun/Documents/CVA6/HwDesigns/HwComp_SystemVerilog/Comparators/Comparators.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CompBin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CompBin.tcl -notrace
