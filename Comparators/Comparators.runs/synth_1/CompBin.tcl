...
synth_design -top CompBin -part xc7k325tffg900-2
...
write_checkpoint -force -noxdef CompBin.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file CompBin_utilization_synth.rpt -pb CompBin_utilization_synth.pb"  } 
